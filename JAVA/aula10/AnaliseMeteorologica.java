...
public class AnaliseMeteorologica {
    ...
    //============= método calcularMediaPonderadaTemperatura ========================
     ...
     public static void calcularMediaPonderadaTemperatura(double max, double min, double[][] temperaturas) {
    ...
    public static void classificarClima(double tempMedia, int umidadeMedia){
        ...
        tempMedia = 0;    //variável double pq é número quebrado
        umidadeMedia = 0;    //int pq é um número inteiro
    ...
    public static void identificarCidadeComMaiorAmplitudeTermica(double[][] temperaturas){
